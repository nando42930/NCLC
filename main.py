...
# plot_correlation_heatmap(imp_numeric_df)
...
# imp_numeric_df = encode_categorical_features(df_imp_language)     # MODIFIES CATEGORICAL FEATURES TO NUMERIC
# spearman_correlation(imp_numeric_df)
...
# anova_kruskal_test(df_imp_language, normality_method='shapiro')   # USES SHAPIRO-WILK
# anova_kruskal_test(df_imp_language, normality_method='ks')        # USES KOLMOGOROV-SMIRNOV


""" RANDOM FOREST REGRESSOR OR CLASSIFIER ANALYSES """
# analyze_relationship(df_main, r2_threshold=0.7, accuracy_threshold=0.94)

# TODO: Include 'Implementation Language' in this analysis
# analyze_relationship(df_imp_language, r2_threshold=0.7, accuracy_threshold=0.94)
